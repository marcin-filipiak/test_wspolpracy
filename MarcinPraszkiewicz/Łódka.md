...
- **Okno z wodą**: Obszar, na którym porusza się łódka. Graficznie przedstawia wodę, na której żaglówka przemieszcza się w zależności od wiatru.
...
### 1.4. **Zmienne w grze:**
- **Kierunek wiatru**: Wiatr może wiać z różnych kierunków, co wpływa na prędkość łódki. Wiatr może zmieniać kierunek i siłę w czasie, co zmienia dynamikę rozgrywki.
...
Akcje:
 ...
 2. Aplikacja oblicza nowy kurs łódki.
 ...
 7. Łódka zmienia kurs, a żagiel dostosowuje się do nowego kierunku, aby optymalizować prędkość. Wskaźnik prędkości zmienia się odpowiednio do siły wiatru i ustawienia żagli.
...
2. Aplikacja oblicza wymagany kąt ustawienia żagla względem kierunku wiatru.
...
5. Prędkość łódki jest obliczana na podstawie siły wiatru oraz ustawienia żagli.
Oczekiwany rezultat:
...
Opis:
Siła wiatru wpływa na prędkość łódki. Wiatr z różnych kierunków ma różny wpływ na poruszanie się łódki.

Akcje:
 1. Wiatr w aplikacji zmienia swój kierunek i siłę.
 2. Aplikacja oblicza prędkość łódki na podstawie siły wiatru oraz kąta ustawienia żagla.
...
Akcje:
 1. Wiatr zmienia kierunek w aplikacji.
 2. Róża wiatrów aktualizuje kierunek wiatru na podstawie jego zmiany.
 3. Obok róży wiatrów pojawia się tekstowy opis kierunku wiatru (np. "Northeast - wiatr z północnego wschodu").
...
Akcje:
 1. Gracz wciska odpowiedni przycisk lub klawisz.
 2. Aplikacja obraca łódkę w zależności od polecenia gracza.
 3. Róża wiatrów oraz kierunek wiatru są aktualizowane w zależności od obrotu łódki.
 4. Po obróceniu łódki, żagiel automatycznie dostosowuje swój kąt w zależności od nowego kursu.
Oczekiwany rezultat:
...
Opis:
Prędkość łódki jest dynamicznie obliczana w zależności od siły wiatru oraz ustawienia żagli.

Akcje:
 1. Wiatr zmienia swoją siłę.
 2. Aplikacja przelicza aktualną prędkość łódki na podstawie zmiennej siły wiatru oraz kąta żagli.
 3. Gracz obserwuje zmieniającą się prędkość na wskaźniku prędkości oraz na mapie.
 4. Łódka przyspiesza lub zwalnia w zależności od warunków atmosferycznych.
Oczekiwany rezultat:
